			...
			Program "vp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat16 = in_TEXCOORD1.x * 0.000244140625;
					    u_xlat3.x = floor(u_xlat16);
					    u_xlat3.y = (-u_xlat3.x) * 4096.0 + in_TEXCOORD1.x;
					    u_xlat3.xy = u_xlat3.xy * vec2(0.001953125, 0.001953125);
					    vs_TEXCOORD0.zw = u_xlat3.xy * _FaceTex_ST.xy + _FaceTex_ST.zw;
					    vs_TEXCOORD1.xy = u_xlat3.xy * _OutlineTex_ST.xy + _OutlineTex_ST.zw;
					    vs_TEXCOORD0.xy = in_TEXCOORD0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
					    u_xlat16 = u_xlat2.y * unity_StereoMatrixVP[(u_xlati15 + 1) / 4][(u_xlati15 + 1) % 4].w;
					    u_xlat16 = unity_StereoMatrixVP[u_xlati15 / 4][u_xlati15 % 4].w * u_xlat2.x + u_xlat16;
					    u_xlat16 = unity_StereoMatrixVP[(u_xlati15 + 2) / 4][(u_xlati15 + 2) % 4].w * u_xlat2.z + u_xlat16;
					    u_xlat16 = unity_StereoMatrixVP[(u_xlati15 + 3) / 4][(u_xlati15 + 3) % 4].w * u_xlat2.w + u_xlat16;
					    u_xlat2.xy = _ScreenParams.yy * unity_StereoMatrixP[(u_xlati15 + 1) / 4][(u_xlati15 + 1) % 4].xy;
					    u_xlat2.xy = unity_StereoMatrixP[u_xlati15 / 4][u_xlati15 % 4].xy * _ScreenParams.xx + u_xlat2.xy;
					    u_xlat2.xy = u_xlat2.xy * vec2(_ScaleX, _ScaleY);
					    ...
					    u_xlat7.xyz = unity_WorldToObject[1].xyz * unity_StereoWorldSpaceCameraPos[u_xlati2].yyy;
					    u_xlat7.xyz = unity_WorldToObject[0].xyz * unity_StereoWorldSpaceCameraPos[u_xlati2].xxx + u_xlat7.xyz;
					    u_xlat7.xyz = unity_WorldToObject[2].xyz * unity_StereoWorldSpaceCameraPos[u_xlati2].zzz + u_xlat7.xyz;
					    u_xlat3.xyz = (-u_xlat1.xyz) + unity_StereoWorldSpaceCameraPos[u_xlati2].xyz;
					    u_xlat2.xyz = u_xlat7.xyz + unity_WorldToObject[3].xyz;
					    u_xlat0.z = in_POSITION0.z;
					    u_xlat0.xyz = (-u_xlat0.xyz) + u_xlat2.xyz;
					    u_xlat0.x = dot(in_NORMAL0.xyz, u_xlat0.xyz);
					    u_xlati5 = int((0.0<u_xlat0.x) ? 0xFFFFFFFFu : uint(0));
					    ...
					    u_xlat4.xyz = u_xlat0.xyz * u_xlat2.wxy;
					    u_xlat4.xyz = u_xlat2.ywx * u_xlat0.yzx + (-u_xlat4.xyz);
					    u_xlat15 = in_TANGENT0.w * unity_WorldTransformParams.w;
					    u_xlat4.xyz = vec3(u_xlat15) * u_xlat4.xyz;
					    vs_TEXCOORD2.y = u_xlat4.x;
					    vs_TEXCOORD2.z = u_xlat2.x;
					    ...
					    vs_TEXCOORD6.xyz = _EnvMatrix[2].xyz * u_xlat3.zzz + u_xlat0.xyz;
					    u_xlat0.x = u_xlat2.y * u_xlat2.y;
					    u_xlat0.x = u_xlat2.x * u_xlat2.x + (-u_xlat0.x);
					    u_xlat1 = u_xlat2.ywzx * u_xlat2;
					    u_xlat2.x = dot(unity_SHBr, u_xlat1);
			...
			Program "vp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    vs_TEXCOORD1.xy = u_xlat3.xy * _OutlineTex_ST.xy + _OutlineTex_ST.zw;
					    vs_TEXCOORD0.xy = in_TEXCOORD0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
					    u_xlat7.x = u_xlat2.y * unity_StereoMatrixVP[(u_xlati15 + 1) / 4][(u_xlati15 + 1) % 4].w;
					    u_xlat2.x = unity_StereoMatrixVP[u_xlati15 / 4][u_xlati15 % 4].w * u_xlat2.x + u_xlat7.x;
					    u_xlat2.x = unity_StereoMatrixVP[(u_xlati15 + 2) / 4][(u_xlati15 + 2) % 4].w * u_xlat2.z + u_xlat2.x;
					    u_xlat2.x = unity_StereoMatrixVP[(u_xlati15 + 3) / 4][(u_xlati15 + 3) % 4].w * u_xlat2.w + u_xlat2.x;
					    u_xlat7.xy = _ScreenParams.yy * unity_StereoMatrixP[(u_xlati15 + 1) / 4][(u_xlati15 + 1) % 4].xy;
					    u_xlat7.xy = unity_StereoMatrixP[u_xlati15 / 4][u_xlati15 % 4].xy * _ScreenParams.xx + u_xlat7.xy;
					    ...
					    u_xlat3.xyz = unity_WorldToObject[1].xyz * unity_StereoWorldSpaceCameraPos[u_xlati7].yyy;
					    u_xlat3.xyz = unity_WorldToObject[0].xyz * unity_StereoWorldSpaceCameraPos[u_xlati7].xxx + u_xlat3.xyz;
					    u_xlat3.xyz = unity_WorldToObject[2].xyz * unity_StereoWorldSpaceCameraPos[u_xlati7].zzz + u_xlat3.xyz;
					    ...
					    u_xlat0.x = inversesqrt(u_xlat0.x);
					    u_xlat0.xyz = u_xlat0.xxx * u_xlat3.xyz;
					    u_xlat3.xyz = unity_ObjectToWorld[3].xyz * in_POSITION0.www + u_xlat1.xyz;
					    u_xlat1 = unity_ObjectToWorld[3] * in_POSITION0.wwww + u_xlat1;
					    u_xlat7.xyz = (-u_xlat3.xyz) + unity_StereoWorldSpaceCameraPos[u_xlati7].xyz;
					    vs_TEXCOORD5.xyz = u_xlat3.xyz;
					    u_xlat3.x = dot(u_xlat7.xyz, u_xlat7.xyz);
					    u_xlat3.x = inversesqrt(u_xlat3.x);
					    u_xlat3.xyz = u_xlat7.xyz * u_xlat3.xxx;
					    u_xlat3.x = dot(u_xlat0.yzx, u_xlat3.xyz);
					    vs_TEXCOORD6.y = abs(u_xlat3.x) * u_xlat15 + u_xlat2.x;
					    u_xlatb15 = 0.0>=in_TEXCOORD1.y;
					    u_xlat15 = u_xlatb15 ? 1.0 : float(0.0);
					    u_xlat2.x = (-_WeightNormal) + _WeightBold;
					    u_xlat15 = u_xlat15 * u_xlat2.x + _WeightNormal;
					    ...
					    vs_TEXCOORD4.y = u_xlat4.z;
					    vs_COLOR0 = in_COLOR0;
					    u_xlat0.xyz = u_xlat7.yyy * _EnvMatrix[1].xyz;
					    u_xlat0.xyz = _EnvMatrix[0].xyz * u_xlat7.xxx + u_xlat0.xyz;
					    vs_TEXCOORD7.xyz = _EnvMatrix[2].xyz * u_xlat7.zzz + u_xlat0.xyz;
					    u_xlat0.xyz = u_xlat1.yyy * unity_WorldToLight[1].xyz;
					    u_xlat0.xyz = unity_WorldToLight[0].xyz * u_xlat1.xxx + u_xlat0.xyz;
					    u_xlat0.xyz = unity_WorldToLight[2].xyz * u_xlat1.zzz + u_xlat0.xyz;
					    vs_TEXCOORD8.xyz = unity_WorldToLight[3].xyz * u_xlat1.www + u_xlat0.xyz;
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    vs_TEXCOORD1.xy = u_xlat3.xy * _OutlineTex_ST.xy + _OutlineTex_ST.zw;
					    vs_TEXCOORD0.xy = in_TEXCOORD0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
					    u_xlat13 = u_xlat2.y * unity_StereoMatrixVP[(u_xlati12 + 1) / 4][(u_xlati12 + 1) % 4].w;
					    u_xlat13 = unity_StereoMatrixVP[u_xlati12 / 4][u_xlati12 % 4].w * u_xlat2.x + u_xlat13;
					    u_xlat13 = unity_StereoMatrixVP[(u_xlati12 + 2) / 4][(u_xlati12 + 2) % 4].w * u_xlat2.z + u_xlat13;
					    u_xlat13 = unity_StereoMatrixVP[(u_xlati12 + 3) / 4][(u_xlati12 + 3) % 4].w * u_xlat2.w + u_xlat13;
					    u_xlat2.xy = _ScreenParams.yy * unity_StereoMatrixP[(u_xlati12 + 1) / 4][(u_xlati12 + 1) % 4].xy;
					    u_xlat2.xy = unity_StereoMatrixP[u_xlati12 / 4][u_xlati12 % 4].xy * _ScreenParams.xx + u_xlat2.xy;
					    u_xlat2.xy = u_xlat2.xy * vec2(_ScaleX, _ScaleY);
					    ...
					    u_xlat12 = u_xlat12 * 1.5 + (-u_xlat13);
					    u_xlati2 = unity_StereoEyeIndex;
					    u_xlat6.xyz = unity_WorldToObject[1].xyz * unity_StereoWorldSpaceCameraPos[u_xlati2].yyy;
					    u_xlat6.xyz = unity_WorldToObject[0].xyz * unity_StereoWorldSpaceCameraPos[u_xlati2].xxx + u_xlat6.xyz;
					    u_xlat6.xyz = unity_WorldToObject[2].xyz * unity_StereoWorldSpaceCameraPos[u_xlati2].zzz + u_xlat6.xyz;
					    u_xlat3.xyz = (-u_xlat1.xyz) + unity_StereoWorldSpaceCameraPos[u_xlati2].xyz;
					    vs_TEXCOORD5.xyz = u_xlat1.xyz;
					    u_xlat1.xyz = u_xlat6.xyz + unity_WorldToObject[3].xyz;
					    u_xlat0.z = in_POSITION0.z;
					    ...
					    u_xlat0.x = float(u_xlati0);
					    u_xlat0.xyz = u_xlat0.xxx * in_NORMAL0.xyz;
					    u_xlat1.y = dot(u_xlat0.xyz, unity_WorldToObject[0].xyz);
					    u_xlat1.z = dot(u_xlat0.xyz, unity_WorldToObject[1].xyz);
					    u_xlat1.x = dot(u_xlat0.xyz, unity_WorldToObject[2].xyz);
					    u_xlat0.x = dot(u_xlat1.xyz, u_xlat1.xyz);
					    u_xlat0.x = inversesqrt(u_xlat0.x);
