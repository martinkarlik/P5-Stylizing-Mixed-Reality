			...
			Program "vp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat2 = u_xlat1.yyyy * unity_StereoMatrixVP[(u_xlati6 + 1) / 4][(u_xlati6 + 1) % 4];
					    u_xlat2 = unity_StereoMatrixVP[u_xlati6 / 4][u_xlati6 % 4] * u_xlat1.xxxx + u_xlat2;
					    u_xlat2 = unity_StereoMatrixVP[(u_xlati6 + 2) / 4][(u_xlati6 + 2) % 4] * u_xlat1.zzzz + u_xlat2;
					    u_xlat1 = unity_StereoMatrixVP[(u_xlati6 + 3) / 4][(u_xlati6 + 3) % 4] * u_xlat1.wwww + u_xlat2;
					    ...
					    vs_TEXCOORD0.xy = in_TEXCOORD0.xy;
					    u_xlat8.x = _ScreenParams.x * unity_StereoMatrixP[u_xlati6 / 4][u_xlati6 % 4].x;
					    u_xlat8.y = _ScreenParams.y * unity_StereoMatrixP[(u_xlati6 + 1) / 4][(u_xlati6 + 1) % 4].y;
