			...
			Program "vp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat1 = u_xlat7.yyyy * unity_ObjectToWorld[1];
					    u_xlat1 = unity_ObjectToWorld[0] * u_xlat7.xxxx + u_xlat1;
					    u_xlat1 = unity_ObjectToWorld[2] * in_POSITION0.zzzz + u_xlat1;
					    u_xlat2 = u_xlat1 + unity_ObjectToWorld[3];
					    u_xlat3 = u_xlat2.yyyy * unity_StereoMatrixVP[(u_xlati21 + 1) / 4][(u_xlati21 + 1) % 4];
					    u_xlat3 = unity_StereoMatrixVP[u_xlati21 / 4][u_xlati21 % 4] * u_xlat2.xxxx + u_xlat3;
					    u_xlat3 = unity_StereoMatrixVP[(u_xlati21 + 2) / 4][(u_xlati21 + 2) % 4] * u_xlat2.zzzz + u_xlat3;
					    u_xlat2 = unity_StereoMatrixVP[(u_xlati21 + 3) / 4][(u_xlati21 + 3) % 4] * u_xlat2.wwww + u_xlat3;
					    u_xlat3.xy = _ScreenParams.yy * unity_StereoMatrixP[(u_xlati21 + 1) / 4][(u_xlati21 + 1) % 4].xy;
					    u_xlat3.xy = unity_StereoMatrixP[u_xlati21 / 4][u_xlati21 % 4].xy * _ScreenParams.xx + u_xlat3.xy;
					    ...
					    u_xlatb21 = 0.0==unity_StereoMatrixP[(u_xlati21 + 3) / 4][(u_xlati21 + 3) % 4].w;
					    if(u_xlatb21){
					        ...
					        u_xlat6.xyz = u_xlat7.yyy * unity_ObjectToWorld[1].xyz;
					        u_xlat6.xyz = unity_ObjectToWorld[0].xyz * u_xlat7.xxx + u_xlat6.xyz;
					        u_xlat6.xyz = unity_ObjectToWorld[2].xyz * in_POSITION0.zzz + u_xlat6.xyz;
					        u_xlat6.xyz = unity_ObjectToWorld[3].xyz * in_POSITION0.www + u_xlat6.xyz;
					        u_xlati17 = unity_StereoEyeIndex;
					        u_xlat6.xyz = (-u_xlat6.xyz) + unity_StereoWorldSpaceCameraPos[u_xlati17].xyz;
					    ...
					    u_xlat0.xyz = unity_ObjectToWorld[3].xyz * in_POSITION0.www + u_xlat1.xyz;
					    u_xlati21 = unity_StereoEyeIndex;
					    u_xlat0.xyz = (-u_xlat0.xyz) + unity_StereoWorldSpaceCameraPos[u_xlati21].xyz;
