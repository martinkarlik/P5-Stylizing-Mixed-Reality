...
// Index data for cube
const std::vector<unsigned short> c_cubeIndexData = {
    0, 2, 1,
    1, 2, 3,
    4, 5, 6,
    5, 7, 6,
...
void TestScene::onRender(Renderer& renderer, Renderer::RenderTarget& target, const glm::mat4x4& viewMat, const glm::mat4x4& projMat, void* userData) const
{
