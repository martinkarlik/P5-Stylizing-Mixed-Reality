...
/**
 * Camera property types that can be accessed to control video see through cameras.
 *
...
/**
 * Camera property modes that can be set to control video see through cameras.
 *
