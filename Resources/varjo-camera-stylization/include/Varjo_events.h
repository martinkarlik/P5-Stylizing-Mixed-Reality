...
static const varjo_EventType varjo_EventType_HeadsetStandbyStatus = 0x6;    //!< Event for changes in headset standby status.
...
static const varjo_EventType varjo_EventType_FoveationStatus = 0xC;         //!< Event emitted when foveation status has changed.

#define VARJO_LAST_EVENT varjo_EventType_FoveationStatus
...
typedef int64_t varjo_FoveationStatus;
static const varjo_FoveationStatus varjo_FoveationStatus_Ok = 0x0;          //!< Foveation is ok.
static const varjo_FoveationStatus varjo_FoveationStatus_Disabled = 0x1;    //!< Foveation is disabled (gaze tracking is lost for example).
...
struct varjo_EventFoveationStatus {
    varjo_FoveationStatus status; //!< Foveation status.
};
...
union varjo_EventData {
    ...
    struct varjo_EventFoveationStatus foveationStatus;                //!< Foveation status event data.
};
