 ...
 *
 * When using layers, this function replaces the call to #varjo_EndFrame. The submitInfo parameter
 * contains the list of layers that are to be displayed. See #varjo_SubmitInfoLayers documentation
