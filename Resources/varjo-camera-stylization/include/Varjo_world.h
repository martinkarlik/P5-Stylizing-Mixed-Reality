 ...
 * in a different varjo_World.
 *
 * @param session Varjo session the world should be initialized for.
 * @param worldFlags Flags for the world initialization.
 ...
 *
 * Gets the latest tracking pose for all objects in the world.
 * @ref varjo_WorldGetObjects will return the latest state for each component
 * type after this call.
 *
 * Call this function every time you want to get the latest tracking data from Varjo backend.
 *
